...
INSERT INTO review VALUES(
	...
	'James Cameron`s `Titanic` shares a similar motto to Marmite, `you either love it or hate it`, I for one love this film, yes I know it`s got a drawn out romance story, but there`s just something about the 3-hour fill of the film that makes its such a spectacularly emotional and beautiful movie. I saw this a lot when I was growing up, this was one of the films of my childhood, it is truly a powerfully resonant and visually stunning movie of epic proportions.',
	10,
	'user_paul',
    'tt0120338'
  );
...
INSERT INTO review VALUES(
	...
	'This is simply the best movie ever made, containing all the elements a perfect movie should, even considering that every person has a right to his/her opinion. The soundtrack is amazing, the scenes are ingenious and the story is simply excellent! This is a story about a Scotsman named William Wallace (Mel Gibson) and his fight for the freedom of the Scottish people, from the oppression of the English ruler-ship.',
    9,
	'user_paul',
	'tt0112573'
  );
...
INSERT INTO person VALUES(
    STR_TO_DATE('1964-4-7' , '%Y-%m-%d'),
    'Russell Crowe',
	1
  );

INSERT INTO person VALUES(
    STR_TO_DATE('1974-11-11' , '%Y-%m-%d'),
    'Leonardo DiCaprio',
	2
  );
  
INSERT INTO person VALUES(
    STR_TO_DATE('1924-4-3' , '%Y-%m-%d'),
    'Marlon Brando',
	3
  );
  
INSERT INTO person VALUES(
    STR_TO_DATE('1990-4-23' , '%Y-%m-%d'),
    'Dev Patel',
	4
  );
  
INSERT INTO person VALUES(
    STR_TO_DATE('1970-5-27' , '%Y-%m-%d'),
    'Joseph Fiennes',
	5
  );
--INSERT SOME ROLES--
